...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">Welcome to VKNRL Conference Portal
        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                {{-- <a href="{{route("student.application.process-payment", Crypt::encrypt($conference->id))}}"><button type="button" class="btn btn-warning btn-sm">Go for Payment</button></a> --}}
                            </div>
                        </div>
                    </div>
