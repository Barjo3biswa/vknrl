...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $who=$request->who;
        return view('student.auth.login',compact('who'));
    }
     /**
    ...
    {
        // dd($request->all());
        $login_as= Crypt::decrypt($request->who);
        ...
        $request->merge(["category" => $login_as]);
        // dd($login_as);
    ...
    {
        return $request->only($this->username(), 'password','category');
    }
}
